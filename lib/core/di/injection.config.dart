...
import '../../features/donated_books/presentation/bloc/donated_books_bloc.dart'
    as _i253;
import '../../features/explore/presentation/bloc/explore_bloc.dart' as _i571;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i894.ProfileRepository>(
        () => _i334.ProfileRepositoryImpl(gh<_i559.ProfileRemoteDataSource>()));
    ...
    gh.factory<_i571.ExploreBloc>(() => _i571.ExploreBloc(
          categoryDataSource: gh<_i212.CategoryRemoteDataSource>(),
          bookDataSource: gh<_i673.BookCrudRemoteDataSource>(),
        ));
    ...
    gh.factory<_i900.ResendRegisterOtpUseCase>(
        () => _i900.ResendRegisterOtpUseCase(gh<_i787.AuthRepository>()));
    ...
    gh.factory<_i725.SignUpBloc>(() => _i725.SignUpBloc(
          ...
          gh<_i900.ResendRegisterOtpUseCase>(),
        ));
    return this;
  }
}
