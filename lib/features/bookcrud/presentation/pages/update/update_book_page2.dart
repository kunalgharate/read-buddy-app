      ...
      builder: (context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              const Text('Choose a Photo', style: TextStyle(fontSize: 20)),
...
//           base64Images = await Future.wait(images.map((image) async {
//             return await ImagePickerHelper().convertImageToBase64(image);
//           }));
//         }
//       } else {
...
//           // Convert to base64 and store
//           final base64Image =
//               await ImagePickerHelper().convertImageToBase64(image);
