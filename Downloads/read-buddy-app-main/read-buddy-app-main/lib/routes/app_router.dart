...
import 'package:read_buddy_app/features/onboarding/presentation/screens/onboarding_questionaire.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case '/banner':
        ...
        return MaterialPageRoute(builder: (_) => const OnboardingQuestionScreen());
      default:
