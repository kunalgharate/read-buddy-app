...
class BannerCollection extends StatelessWidget {
  ...
  const BannerCollection({super.key, required this.banner});
...
void updatedialog(BuildContext context, BannerEntity banner) async {
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context);
                DeleteBanner().confirmDelete(context, banner.id ?? "");
              },
            ),
          ],
        ),
